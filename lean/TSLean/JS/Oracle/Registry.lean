...
def operationRegistry : List String :=
  ["add", "assign-primitive-prototype-is", "assign-string", "box-add", "box-loose", "box-number", "box-object", "box-prototype-is", "box-string", "box-valueof", "call-with-argument", "div", "finally-order", "finally-return", "format", "ge", "gt", "intrinsic-tostring", "intrinsic-valueof", "iterate-live", "key", "le", "logical-or", "loose", "lt", "math-abs", "math-ceil", "math-floor", "math-max", "math-min", "math-round", "math-sign", "math-sqrt", "math-trunc", "mul", "mutate-intrinsic-prototype", "mutate-wrapper-prototype", "number", "parse", "rem", "short-circuit-assignment", "spread-count", "spread-overwrite", "spread-string", "string", "sub", "symbol-key-for", "throw-value", "truthiness-empty-array", "typeof-string-check", "utf16-fields", "value-add", "value-ge", "value-gt", "value-identity", "value-instanceof", "value-le", "value-loose", "value-lt", "value-number", "value-strict", "value-string", "while-call-once"]

def operationSpec? (operation : String) : Option OperationSpec :=
  if ["format", "key", "math-abs", "math-ceil", "math-floor", "math-round", "math-sign", "math-sqrt", "math-trunc", "number", "parse", "string"].contains operation then some ⟨1, .primitive⟩
  else if ["add", "div", "ge", "gt", "le", "loose", "lt", "math-max", "math-min", "mul", "rem", "sub"].contains operation then some ⟨2, .primitive⟩
