...
def hasDOPattern (source : String) : Bool :=
  ((((source.includes "DurableObjectState") || (source.includes "DurableObjectStorage")) || (source.includes "DurableObjectNamespace")) || (source.includes "state.storage")) || (source.includes "extends DurableObject")
