...
const STRING_METHODS: Record<string, MethodTx> = {
  ...
  includes:     { leanFn: 'String.isInfixOf', argOrder: 'flip', resultType: TyBool },
  startsWith:   { leanFn: 'String.startsWith', resultType: TyBool },
  endsWith:     { leanFn: 'String.endsWith',  resultType: TyBool },
  slice:        { leanFn: 'String.extract',   resultType: TyString },
  substring:    { leanFn: 'String.extract',   resultType: TyString },
  split:        { leanFn: 'String.splitOn',   resultType: TyArray(TyString) },
  replace:      { leanFn: 'String.replace',   resultType: TyString },
  indexOf:      { leanFn: 'String.firstIndexOf', resultType: TyOption(TyNat) },
  charAt:       { leanFn: 'String.get',       resultType: TyString },
  padStart:     { leanFn: 'String.leftpad',   resultType: TyString },
  padEnd:       { leanFn: 'String.rightpad',  resultType: TyString },
  repeat:       { leanFn: 'String.replicate', resultType: TyString },
...
const GLOBALS: Record<string, GlobalTx> = {
  ...
  'Date.now':       { leanExpr: 'IO.monoNanoseconds',   io: true },
