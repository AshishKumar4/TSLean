...
describe('lookupGlobal', () => {
  ...
  it('Date.now (io)',      () => expect(lookupGlobal('Date.now')?.io).toBe(true));
  it('parseInt',           () => expect(lookupGlobal('parseInt')?.leanExpr).toBe('String.toInt?'));
  it('JSON.stringify',     () => expect(lookupGlobal('JSON.stringify')?.leanExpr).toBe('TSLean.serialize'));
  it('JSON.parse',         () => expect(lookupGlobal('JSON.parse')?.leanExpr).toBe('TSLean.deserialize'));
