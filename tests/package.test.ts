  ...
  it('includes Lean inputs without local build artifacts', () => {
    ...
    expect(files).toEqual(
      expect.arrayContaining([
        ...
        'examples/lean-to-typescript/generated/TSLean/Examples/Placement.ts.map',
        'examples/lean-to-typescript/package/generated/tslean.manifest.json',
        'examples/lean-to-typescript/package/generated/TSLean/Examples/Package/Capability.ts',
        'examples/lean-to-typescript/package/generated/TSLean/Examples/Package/Capability.ts.map',
        'examples/lean-to-typescript/package/generated/TSLean/Examples/Package/Decision.ts',
        'examples/lean-to-typescript/package/generated/TSLean/Examples/Package/Decision.ts.map',
        'examples/lean-to-typescript/package/generated/TSLean/Examples/Package/Policy.ts',
