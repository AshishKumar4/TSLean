...
def hasDOPattern (source : String) : Bool :=
  ((((source.includes "DurableObjectState") || (source.includes "DurableObjectStorage")) || (source.includes "DurableObjectNamespace")) || (source.includes "state.storage")) || (default)
...
def makeAmbientHost (base : String) (virtual : AssocMap String String) : String :=
  default
